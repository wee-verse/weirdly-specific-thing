...
const RESULTS = [
  ...
  { name: "An Empty Chair, Increasingly Relevant", emoji: "🪑", vec: [2,0,0,-1,1],
    blurb: "Someone is about to be missed before they're actually gone. Save them a seat this week.",
  ...
  { name: "A Streetlight That Only Flickers for You", emoji: "💡", vec: [-1,1,1,0,1],
    blurb: "You're being noticed by something that has no other way to say so. Nod once — that's the whole ritual.",
  ...
  { name: "The Elevator That Waits One Extra Second", emoji: "🛗", vec: [-1,0,1,0,-1],
    blurb: "Someone, somewhere, is running to catch up with you. Hold the door — it costs nothing.",
  ...
  { name: "The Radio Station That Finds You in Every Rental Car", emoji: "📻", vec: [-1,1,0,-1,1],
    blurb: "Some part of your taste is more consistent than you're willing to admit. Let it play the whole song.",
  ...
  { name: "A Second Shadow, Briefly, at Noon", emoji: "🌗", vec: [-1,0,1,2,-1],
    blurb: "You're about to be seen more clearly than usual, by someone who matters. Stand still for it.",
    traits: ["Solar anomaly", "Rare", "Brief but flattering"] },
  { name: "The Voicemail Icon That Won't Clear", emoji: "📞", vec: [1,0,-1,-2,1],
    blurb: "Unfinished business is older than you think, and quieter than you'd like. Actually listen to it this time.",
